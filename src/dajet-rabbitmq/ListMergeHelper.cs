...
{
    internal static class ListMergeHelper
    {
        internal static void Compare(List<string> target_list, List<string> source_list, out List<string> delete_list, out List<string> insert_list)
        {
